...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Você vai substituir a URL abaixo pela URL que o Google Apps Script te gerar!
      const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbypfBwo8FRCX8qQbIn6yjhd8AwjHgYoQztDw4ncB-Tw2U3JglbZ7HH8CD6FdrOAv_mEGw/exec";
      
      // Convert FormData to URLSearchParams so Google Apps Script parses it correctly
